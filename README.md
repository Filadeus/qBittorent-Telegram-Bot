...
A python-based Telegram bot to monitor and control your qBittorrent WebUI container.
...
Copy the env template and fill in your details (bot token, user IDs, host details):
```bash
cp .env.example .env
```
